...
export const sketch: Sketch = (p5) => {
  ...
  p5.mouseDragged = () => {
    ...
    // const transformationMatrix = makeTranslation(30, 50)
    // const transformationMatrix = makeScale(2, 3)
    const transformationMatrix = makeRotation(60)
    // const transformationMatrix = makeShear(1, 0)
    const transformedVec = multiplyMatrixVector(transformationMatrix, vec)
